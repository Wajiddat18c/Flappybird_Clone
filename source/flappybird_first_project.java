...
public class flappybird_first_project extends PApplet {
...
public void draw() { //draw kørrer programmet 60 gange pr sek.
  if (gamestate == 0) {
    imageMode(CORNER);
    image(backImg, x, 0);
...
public void mousePressed() { //sker noget når du trykker på særmen.
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "flappybird_first_project" };
    if (passedArgs != null) {
